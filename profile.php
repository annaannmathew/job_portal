...
<body>
    ...
    <div class="sidenav">
        ...
        <div class="sidenav-url">
            ...
            <div class="url">
                <a href="http://localhost/job/registerjk.php?id=<?php echo $id;?>" class="active">Registration Form</a>
                <hr align="center">
            </div>
            </div>
            <div class="url">
                <a href="http://localhost/job/viewjobs.php?id=<?php echo $id;?>" class="active">List</a>
                <hr align="center">
            </div>
        </div>
    </div>
